                ...
                <div class="card-body p-3 ">
                    <div class="row">
                        ...
                        <div class="col-8 text-left text-lead text-secondary">
                            <a href="<?=base_url('cadastre-sua-festa') ?>" class="text-decoration-none d-block">
                                Cadastre Sua Festa Em breve...
                            </a>
                        </div>
                    </div>
                </div>
